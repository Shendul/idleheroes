...
## Each affix potentially affects 0 or more actor stats.
ITEM_AFFIX_TO_ACTOR_STAT_MAP = {
  ## Attributes
  AFFIX.HEALTH: [ACTOR_STAT.HEALTH],
  # AFFIX.MANA: [ACTOR_STAT.MANA],
  AFFIX.STRENGTH: [],
  # AFFIX.AGILITY: [],
  # AFFIX.WISDOM: [],
  # AFFIX.CONSTITUTION: [],
  ...
  ## Armor Specific
  AFFIX.DEFENSE: [ACTOR_STAT.DEFENSE],
  # AFFIX.DEFENSE_PERCENTAGE: [ACTOR_STAT.DEFENSE],
  # AFFIX.PHYSICAL_RESISTANCE: [
  #   ACTOR_STAT.THRUST_RESISTANCE, ACTOR_STAT.CRUSH_RESISTANCE,
  #   ACTOR_STAT.SLASH_RESISTANCE],
  # AFFIX.ELEMENTAL_RESISTANCE: [
  #   ACTOR_STAT.LIGHTNING_RESISTANCE, ACTOR_STAT.FIRE_RESISTANCE,
  #   ACTOR_STAT.COLD_RESISTANCE],
  # AFFIX.THRUST_RESISTANCE: [ACTOR_STAT.THRUST_RESISTANCE],
  # AFFIX.SLASH_RESISTANCE: [ACTOR_STAT.SLASH_RESISTANCE],
  # AFFIX.CRUSH_RESISTANCE: [ACTOR_STAT.CRUSH_RESISTANCE],
  # AFFIX.LIGHTNING_RESISTANCE: [ACTOR_STAT.LIGHTNING_RESISTANCE],
  # AFFIX.FIRE_RESISTANCE: [ACTOR_STAT.FIRE_RESISTANCE],
  # AFFIX.COLD_RESISTANCE: [ACTOR_STAT.COLD_RESISTANCE],
  # AFFIX.POISON_RESISTANCE: [ACTOR_STAT.POISON_RESISTANCE],
  # AFFIX.THORNS: [ACTOR_STAT.THORNS_DAMAGE],

  ## Weapon Specific
  # AFFIX.WEAPON_DAMAGE_PERCENTAGE: [
  #   ACTOR_STAT.THRUST_DAMAGE, ACTOR_STAT.CRUSH_DAMAGE,
  #   ACTOR_STAT.SLASH_DAMAGE],
  # AFFIX.WEAPON_DAMAGE_FLAT: [
  #   ACTOR_STAT.THRUST_DAMAGE, ACTOR_STAT.CRUSH_DAMAGE,
  #   ACTOR_STAT.SLASH_DAMAGE],
  # AFFIX.LIGHTNING_DAMAGE: [ACTOR_STAT.LIGHTNING_DAMAGE],
  # AFFIX.FIRE_DAMAGE: [ACTOR_STAT.FIRE_DAMAGE],
  # AFFIX.COLD_DAMAGE: [ACTOR_STAT.COLD_DAMAGE],
  # AFFIX.POISON_DAMAGE: [ACTOR_STAT.POISON_DAMAGE],

  ## Accessory Specific
  # AFFIX.GOLD_FIND: [ACTOR_STAT.GOLD_FIND],
  # AFFIX.MAGIC_FIND: [ACTOR_STAT.MAGIC_FIND],
  # AFFIX.EXP_GAIN: [ACTOR_STAT.EXP_BONUS], ## TODO: Implement exp bonus
}
