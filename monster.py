...
LVL_ONE_MOBS = [MONSTER.RAT]
LVL_TWO_MOBS = [MONSTER.RAT, MONSTER.SNAKE, MONSTER.WOLF, MONSTER.BEAR, 
    MONSTER.RED_SLIME, MONSTER.BLUE_SLIME, MONSTER.YELLOW_SLIME, MONSTER.SLIME]
LVL_THREE_MOBS = [MONSTER.BEAR, MONSTER.DRAGON, MONSTER.RED_SLIME,
    MONSTER.BLUE_SLIME, MONSTER.YELLOW_SLIME, MONSTER.SLIME, MONSTER.FREEZO,
    MONSTER.DRAGON]